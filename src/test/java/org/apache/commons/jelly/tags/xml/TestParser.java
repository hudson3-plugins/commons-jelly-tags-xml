...
public class TestParser extends TestCase {
    ...
    public void testParser() throws Exception {
        InputStream in = getClass().getResourceAsStream("example2.jelly");
        ...
        // Failing test disabled pending investigation - Bob Foster
     ...
     * Failing test disabled pending investigation - Bob Foster
     */
    protected void noassertTagsHaveParent(Script script, Tag parent, JellyContext context) throws Exception {
        if ( context == null )
        ...
        if ( script instanceof TagScript ) {
            ...
            noassertTagsHaveParent( tag.getBody(), tag, context );
        }
            ...
            for ( Iterator iter = block.getScriptList().iterator(); iter.hasNext(); ) {
                noassertTagsHaveParent( (Script) iter.next(), parent, context );
            }
        }
    }
}